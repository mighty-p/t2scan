...
/*
  ...
  fe_time_slicing_t          time_slicing                :2; // only defined in t2scan.       0..2  -> 2 -> 2 (3)   23    //
  ...
  fe_alpha_t                 alpha                       :2; // only defined in t2scan                              26    //
  fe_interleave_t            interleaver                 :2; // only defined in t2scan                              27    //
  fe_priority_t              priority                    :2; // only defined in t2scan                              27    //
  fe_mpe_fec_t               mpe_fec                     :2; // only defined in t2scan                              27    //
