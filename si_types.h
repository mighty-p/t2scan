...
struct transponder {
  ...
  unsigned                   time_slicing                :2; /* only defined in t2scan.       0..2  -> 2 -> 2 (3)   23    */
  ...
  fe_interleave_t            terr_interleaver            :2; /* only defined in t2scan                              27    */
  unsigned                   priority                    :1; /* only defined in t2scan                              27    */
